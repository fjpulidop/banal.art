...
const translations = {
  en: {
    ...
    copied: "Copied!",
    shareToggle: "Public sharing",
    enableShare: "Create share link",
    revokeShare: "Revoke share link",
    revokeShareConfirm: "Revoke this public share link? The old URL will stop working immediately.",
    shareUrlCopied: "Share URL copied!",
    shareLoading: "Updating share link...",
    shareError: "Could not update the share link.",
    publicShareUnavailable: "This shared critique is unavailable.",
    readOnlyShareLabel: "Read-only shared critique",
    deleteCritique: "Delete",
  ...
  es: {
    ...
    copied: "Copiado!",
    shareToggle: "Compartir publicamente",
    enableShare: "Crear enlace compartido",
    revokeShare: "Revocar enlace compartido",
    revokeShareConfirm: "Revocar este enlace publico? La URL anterior dejara de funcionar inmediatamente.",
    shareUrlCopied: "Enlace copiado!",
    shareLoading: "Actualizando enlace...",
    shareError: "No se pudo actualizar el enlace.",
    publicShareUnavailable: "Esta critica compartida no esta disponible.",
    readOnlyShareLabel: "Critica compartida de solo lectura",
    deleteCritique: "Eliminar",
