...
Launch a **single** product-analyst agent (`subagent_type: Explore`) to read and prioritize the backlog.
...
5. **Display** as a formatted table per area, then **propose the top 3 items** for implementation:
   ...
   Personas: "Carlos" The Comedian, "Lucia" The Content Creator

   ### {Area Name}

   | # | Issue | Carlos (Comedian) | Lucia (Creator) | Total | Effort |
   |---|-------|-------------------|-----------------|-------|--------|
   | 1 | #42 Feature name | X/5 | X/5 | X/10 | Low |
   ...
   | Priority | Issue | Area | Carlos | Lucia | Total | Effort | Rationale |
   |----------|-------|------|--------|-------|-------|--------|-----------|
